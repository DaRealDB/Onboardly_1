      ...
      <motion.div variants={scaleIn} className="w-full max-w-md">
        <div className="bg-white shadow-xl rounded-2xl p-8 border border-slate-100">
          ...
          <motion.div variants={fadeUp} className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#0A1628] mb-2">Create Account</h1>
            <p className="text-slate-600">Start your journey with Onboardly</p>
          </motion.div>
          ...
          <motion.form onSubmit={handleSubmit} className="space-y-6" variants={fadeUp}>
            ...
            <motion.div className="grid grid-cols-2 gap-4" variants={fadeUp}>
              ...
              <div className="space-y-2">
                <Label htmlFor="companyName" className="block text-sm font-medium text-slate-700 mb-2">Company</Label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="h-4 w-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <motion.div variants={fadeUp} className="mt-8 text-center">
            <p className="text-sm text-slate-600">
              ...
              <Link href="/auth/login" className="text-[#2563EB] hover:text-[#1D4ED8] font-semibold transition-colors">
                Sign in here
              </Link>
            </p>
          </motion.div>
