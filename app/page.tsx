  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <motion.header
        ...
        className="fixed top-0 inset-x-0 z-50 bg-white/80 backdrop-blur-sm border-b border-slate-100"
      >
      ...
      {/* Hero */}
      <section className="bg-[#F8FAFC] pt-32 pb-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
          ...
          >
            ...
            <motion.p
              variants={fadeUpVariant}
              className="mt-6 text-xl text-[#475569] max-w-2xl mx-auto leading-relaxed"
            >
              Give professional clients a secure, white-labeled portal to sign
              contracts, upload documents, and complete onboarding — so you can
            ...
            >
              <Link
                href="/auth/signup"
                className="bg-[#2563EB] text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:bg-[#1D4ED8] hover:scale-105 transition-all flex items-center gap-2"
              >
                Start Free Trial <span aria-hidden="true">&rarr;</span>
              </Link>
              <Link
                href="/auth/signup"
                className="bg-white text-[#0F172A] px-8 py-4 rounded-xl font-semibold text-lg border border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-colors flex items-center gap-2"
              >
          ...
          >
            <div className="relative hover:shadow-2xl transition-shadow duration-500 rounded-2xl">
              <motion.div
                className="absolute -top-3 -right-3 z-10 bg-[#16A34A] text-white px-3 py-1.5 rounded-full text-sm font-semibold flex items-center gap-1.5 shadow-lg cursor-default"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
      ...
      {/* Comparison */}
      <section id="case-studies" className="bg-white py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
          ...
          >
            ...
            <p className="mt-4 text-[#475569] max-w-xl mx-auto">
              ...
              organized, it shows your clients that you value their time as much
              as your own. That’s the kind of experience people can’t help but
              rave about.
            </p>
          </motion.div>
              ...
              <div className="bg-red-50/30 border border-red-200 rounded-xl p-4">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    "Troubleshooting technical upload errors",
                  ].map((email, i) => (
                    <div
                      key={i}
      ...
      {/* How It Works */}
      <section id="how-it-works" className="bg-[#F8FAFC] py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            className="text-center mb-16"
            initial="hidden"
          ...
          >
            ...
            <p className="mt-4 text-[#475569]">
              Set up your first white-labeled onboarding portal in less than 10
          ...
          <motion.div
            ...
            variants={staggerContainer}
          >
            <motion.div variants={fadeLeftVariant} className="space-y-6">
              <div className="flex items-center gap-3">
              ...
              <p className="text-[#475569]">
                Your brand deserves the spotlight, not your tools. Quickly add
                your logo and signature colors to create a space that feels like
                home. It’s so seamless, your clients will never know they’ve
                left your site.
              </p>
            ...
            >
              ...
              <div className="flex gap-3 mb-6">
                <div className="w-12 h-12 bg-[#2563EB] rounded-lg hover:scale-110 transition-transform"></div>
                <div className="w-12 h-12 bg-[#0F172A] rounded-lg hover:scale-110 transition-transform"></div>
                <div className="w-12 h-12 bg-[#E2E8F0] rounded-lg hover:scale-110 transition-transform"></div>
              </div>
          ...
          >
            <motion.div
              variants={fadeLeftVariant}
              className="order-2 md:order-1 bg-white rounded-2xl shadow-md p-6"
            >
            ...
            >
              ...
              <p className="text-[#475569]">
                Use the Policy Engine to control the onboarding sequence. Choose
                Strict Mode to enforce contract signatures before file uploads,
                or Parallel Mode for flexible checklists.
              </p>
              <ul className="space-y-2">
                {[
          ...
          >
            <motion.div variants={fadeLeftVariant} className="space-y-6">
              ...
              <p className="text-[#475569]">
                ...
                Dashboard to track real-time progress, identify bottlenecks, and
              ...
              <div className="space-y-3">
                {[
                  ...
                  <motion.div
                    ...
                    className={`px-4 py-3 rounded-lg flex items-center justify-between transition-transform cursor-default ${
                      client.color === "green"
                        ? "bg-green-50"
                        : client.color === "amber"
                          ? "bg-amber-50"
          ...
          >
            {[
              ...
              <motion.div
                variants={fadeUpVariant}
                key={i}
                className="border border-slate-200 rounded-xl p-4 text-center hover:border-[#2563EB] hover:bg-blue-50/30 transition-colors"
              >
      ...
      <section id="pricing" className="bg-[#F8FAFC] py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div
              variants={fadeUpVariant}
              className="bg-white border border-slate-200 rounded-xl p-6 hover:-translate-y-2 hover:shadow-xl transition-all duration-300"
            >
            ...
            <motion.div
              variants={fadeUpVariant}
              className="relative bg-white border-2 border-[#2563EB] rounded-xl p-6 shadow-xl hover:-translate-y-2 transition-all duration-300"
            >
              <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                <span className="bg-[#2563EB] text-white text-sm font-semibold px-3 py-1 rounded-full shadow-md">
                  Most Popular
                </span>
              </div>
              ...
              >
                ...
                {openFaq === i && (
                  <motion.div
                    ...
                    className="px-4 pb-3"
                  >
                    <p className="text-sm text-[#475569] mt-2">{faq.a}</p>
                  </motion.div>
                )}
              </motion.div>
            ))}
      ...
      >
        ...
        >
          ...
          >
            <Link
              href="/auth/signup"
              className="bg-white text-[#2563EB] px-8 py-4 rounded-xl font-semibold text-lg hover:scale-105 transition-all shadow-xl"
            >
          ...
          <motion.div
            variants={fadeUpVariant}
            className="mt-8 flex flex-wrap items-center justify-center gap-8 text-white text-sm"
          >
