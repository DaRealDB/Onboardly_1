...
export function LogicStep() {
  const { setCurrentView, addOnboardingTrack } = useAppStore()
  ...
  const [steps, setSteps] = useState<Step[]>([
    ...
    { id: '2', name: 'ID Verification', mandatory: true, attachments: ['ID Photo'] },
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex gap-2">
              ...
              />
              <Input
                placeholder="Attachment Type Title (e.g., ID Photo)..."
        ...
        <div className="pt-4 flex justify-between">
          ...
          <Button
            ...
            disabled={!trackName.trim() || steps.length === 0}
            className="gap-2"
          >
