...
import { LogicStep } from "./logic-step";
...
export function WizardLayout({ children }: WizardLayoutProps) {
  ...
  // Render logic for when no children are provided
  const renderCurrentStep = () => {
    switch (currentView) {
      ...
      case "wizard-logic":
        return <LogicStep />;
      default:
        return <IdentityStep />; // Default to step 1
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-3xl mx-auto px-4 py-6">
          <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground mt-1">
              Configure your tenant in 3 simple steps
            </p>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        {/* Render children if they exist, otherwise render the step based on view */}
